...
class GetTransactionController {
    ...
    static async getTransactionsOperation(data, corelationId, context, authorizer) {
        try {
            const [rows] = await db.query('SELECT a.*, b.name, b.is_unlimited, b.is_weekly, b.is_yearly, b.coin, b.extra_coin, b.discount_percentage, b.is_limited_time, b.description, b.is_active, b.is_deleted FROM users_payments a LEFT JOIN plans b ON a.plan_id = b.id WHERE a.user_id = ? ORDER BY a.created_at DESC', [authorizer?.id]);
